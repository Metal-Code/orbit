...
const appCss = "/assets/styles-B_4pHTa4.css";
...
function RootComponent() {
  ...
  reactExports.useEffect(() => {
    const saved = localStorage.getItem("devcycle.theme") || "dark";
    document.documentElement.setAttribute("data-theme", saved);
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) });
}
const $$splitComponentImporter$5 = () => import("./register-DD8VAm-5.mjs");
const Route$5 = createFileRoute("/register")({
  head: () => ({
    meta: [{
      title: "Register — DevCycle"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./login-BmegcEsc.mjs");
const Route$4 = createFileRoute("/login")({
  head: () => ({
    meta: [{
      title: "Login — DevCycle"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./join-B04mg373.mjs");
...
const $$splitComponentImporter$2 = () => import("./dashboard-JKKbs9Mh.mjs");
const Route$2 = createFileRoute("/dashboard")({
  head: () => ({
    meta: [{
      title: "Dashboard — DevCycle"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-D-r34p6x.mjs");
...
const $$splitComponentImporter = () => import("./projects._id.timeline-BIs2PAkt.mjs");
const Route = createFileRoute("/projects/$id/timeline")({
  head: () => ({
    meta: [{
      title: "Timeline — DevCycle"
    }]
  }),
